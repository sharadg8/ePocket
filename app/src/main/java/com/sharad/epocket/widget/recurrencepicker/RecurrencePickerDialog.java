...
package com.sharad.epocket.widget.recurrencepicker;
...
public class RecurrencePickerDialog extends DialogFragment implements OnItemSelectedListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecurrence.wkst = EventRecurrence.timeDay2Day(Time.MONDAY);
...
*/
    ...
    public void onClick(View v) {
        if (mEndDateTextView == v) {
            ...
            mDatePickerDialog.setFirstDayOfWeek(Time.MONDAY);
            mDatePickerDialog.setYearRange(YEAR_MIN, YEAR_MAX);
