...
public class TransactionEditText extends EditText {
    ...
    public TransactionEditText(Context context) {
        this(context, null);
    }

    public TransactionEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TransactionEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.TransactionEditText, defStyle, 0);
        mMaximumTextSize = a.getDimension(
                R.styleable.TransactionEditText_maxTextSize, getTextSize());
        mMinimumTextSize = a.getDimension(
                R.styleable.TransactionEditText_minTextSize, getTextSize());
        mStepTextSize = a.getDimension(R.styleable.TransactionEditText_stepTextSize,
