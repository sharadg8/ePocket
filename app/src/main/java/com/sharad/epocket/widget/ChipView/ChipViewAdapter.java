package com.sharad.epocket.widget.ChipView;
...
/**
 * Created by Sharad on 07-Aug-16.
 */
...
public abstract class ChipViewAdapter extends Observable {
    ...
    private List<ChipView.Chip> mChipList;
    ...
    public View getView(ViewGroup parent, int position) {
        View view = null;
        ChipView.Chip chip = getChip(position);
    ...
    public ChipView.Chip getChip(int position) {
     ...
     * @param chip
     */
    public void add(ChipView.Chip chip) {
     ...
     * @param chip
     */
    public void remove(ChipView.Chip chip) {
    ...
    public List<ChipView.Chip> getChipList() {
        return mChipList;
    }

    public void setChipList(List<ChipView.Chip> chipList) {
        mChipList = chipList;
        notifyUpdate();
    }
