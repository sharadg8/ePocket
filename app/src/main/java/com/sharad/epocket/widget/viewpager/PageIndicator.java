package com.sharad.epocket.widget.viewpager;
 ...
 * https://github.com/merhold/extensible-page-indicator
 */
...
public class PageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.PageIndicator, 0, 0);
            circleRadius = (int) a.getDimension(R.styleable.PageIndicator_indicatorRadius, circleRadius);
            circlePadding = (int) a.getDimension(R.styleable.PageIndicator_indicatorPadding, circlePadding);
