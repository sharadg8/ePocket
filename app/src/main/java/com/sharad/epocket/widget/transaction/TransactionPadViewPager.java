...
public class TransactionPadViewPager extends ViewPager {
    ...
    public TransactionPadViewPager(Context context) {
        this(context, null);
    }

    public TransactionPadViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
