...
public class AddTransactionFragment extends Fragment {
    ...
    public static AddTransactionFragment newInstance(int type) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view1 = rootView.findViewById(R.id.at_spin_account);
        View view2 = rootView.findViewById(R.id.at_spin_category);
        View view3 = rootView.findViewById(R.id.at_til_rx_amount);
